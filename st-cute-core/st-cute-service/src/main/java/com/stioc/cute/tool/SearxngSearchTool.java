...
import com.stioc.cute.tool.types.SearxngSearchResponse;
import com.stioc.cute.tool.types.SearxngSearchResult;
...
public class SearxngSearchTool implements CuteTool {
    ...
    public String getTargetResource(Map<String, Object> arguments) {
        ...
        return ToolArgs.of(arguments).getStringTrimmed("query");
    }
    ...
    public String execute(Map<String, Object> arguments, ToolExecutionContext context) {
        ...
        int pageno = (pagenoVal != null && pagenoVal >= 1) ? pagenoVal : 1;
