...
public class CuteChatForOpenAi extends AbstractCuteChat {
            ...
            case USER -> {
                ...
                if (msg.getAttachments() != null && !msg.getAttachments().isEmpty()) {
                    ...
                    for (CuteAttachment att : msg.getAttachments()) {
                        if (att.isImage() && StringUtils.isNotBlank(att.getBase64Data())) {
    ...
    protected Request buildHttpRequest(String bodyJson) {
        String url = Boolean.TRUE.equals(useFullUrl) ? baseUrl : (baseUrl + ProviderProtocol.OPENAI.getPathSuffix());
